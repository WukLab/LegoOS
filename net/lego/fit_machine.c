...
static struct fit_machine_info WUKLAB_CLUSTER[] = {
[0]	= {	.hostname =	"wuklab00",	.lid =	2,	.first_qpn =	72,	},
[1]	= {	.hostname =	"wuklab01",	.lid =	6,	.first_qpn =	72,	},
[2]	= {	.hostname =	"wuklab02",	.lid =	8,	.first_qpn =	72,	},
[3]	= {	.hostname =	"wuklab03",	.lid =	9,	.first_qpn =	72,	},
[4]	= {	.hostname =	"wuklab04",	.lid =	7,	.first_qpn =	72,	},
[5]	= {	.hostname =	"wuklab05",	.lid =	3,	.first_qpn =	72,	},
[6]	= {	.hostname =	"wuklab06",	.lid =	5,	.first_qpn =	72,	},
[7]	= {	.hostname =	"wuklab07",	.lid =	4,	.first_qpn =	72,	},
[8]	= {	.hostname =	"wuklab08",	.lid =	10,	.first_qpn =	72,	},
[9]	= {	.hostname =	"wuklab09",	.lid =	12,	.first_qpn =	72,	},
[10]	= {	.hostname =	"wuklab10",	.lid =	11,	.first_qpn =	72,	},
[11]	= {	.hostname =	"wuklab11",	.lid =	14,	.first_qpn =	72,	},
[12]	= {	.hostname =	"wuklab12",	.lid =	13,	.first_qpn =	72,	},
[13]	= {	.hostname =	"wuklab13",	.lid =	15,	.first_qpn =	72,	},
[14]	= {	.hostname =	"wuklab14",	.lid =	16,	.first_qpn =	72,	},
[15]	= {	.hostname =	"wuklab15",	.lid =	17,	.first_qpn =	72,	},
[16]	= {	.hostname =	"wuklab16",	.lid =	20,	.first_qpn =	72,	},
[17]	= {	.hostname =	"wuklab17",	.lid =	21,	.first_qpn =	72,	},
[18]	= {	.hostname =	"wuklab18",	.lid =	19,	.first_qpn =	72,	},
